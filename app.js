...
const translations = {
    ru: {
        ...
        welcome_step1: "Отправьте файл (фото, видео, документ) боту.",
        welcome_step2: "Он автоматически сохранится в облаке.",
        welcome_step3: "Нажмите на файл в приложении, чтобы получить его обратно.",
    ...
    en: {
        ...
        welcome_step1: "Send a file (photo, video, doc) to the bot.",
        welcome_step2: "It automatically saves to your cloud.",
        welcome_step3: "Tap the file in the app to retrieve it.",
